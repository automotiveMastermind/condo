// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GetPolymerMetadata.cs" company="automotiveMastermind and contributors">
...
namespace AM.Condo.Tasks
{
    ...
    /// <summary>
    /// Represents a Microsoft Build task that retrieves project metadata from a polymer project file.
    /// </summary>
    public class GetPolymerMetadata : Task
    {
        ...
        #region Methods
        /// <summary>
        /// Executes the <see cref="GetPolymerMetadata"/> task.
        /// </summary>
        /// <returns>
        ...
        private void SetMetadata(ITaskItem project)
        {
            ...
            var json = File.ReadAllText(nodePath);
